...
I am currently completing a PhD in cosmology, working on data simulations and analysis pipelines for next-generation CMB experiments, with an emphasis on optimizing them for the search for primordial gravitational waves through CMB polarization observations. I am a member of the [Simons Observatory](https://simonsobservatory.org/) and [CMB-S4](https://cmb-s4.org/) and collaborations. I also work on the study of the [PICO concept mission](https://science.nasa.gov/wp-content/uploads/2023/04/PICO_Study_Rpt.pdf?emrc=30c7fb).
